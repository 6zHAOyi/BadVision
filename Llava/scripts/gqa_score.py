...
parser.add_argument('--dir',            default="./playground/data/eval/gqa/data", type=str, help = "The base dir of the json files.")
...
questions = loadFile(os.path.join(args.dir, args.questions.format(tier = args.tier)))
...
predictions = loadFile(os.path.join(args.dir, args.predictions.format(tier = args.tier)))
